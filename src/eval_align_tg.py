...
""" Evaluate forced alignment output, compare to gold standard
	...
	To run:
		python src/eval_align_tg.py --gold_dir {gold_dir} --pred_dir {pred_dir}
		python src/eval_align_tg.py --gold_dir {gold_dir} --pred_dir {pred_dir} --natural_class_tsv {natural_class_tsv}
	Example run:
